...
public class Lampak {
    ...
    //A játék címe és leírása
     public void szabalyok(){
         leir("O---------O---------O");
         leir(" LightOn Szabalyai:");
         leir("O---------O---------O");
         leir("-A jatekban kizarolag 1 es 3 kozotti szamokat szabad megadni.");
         leir("-A jatekot felhasznalonak atirni tilos.");
         leir("-Ha hibat velt felfedezni, arrol irjon a szoftver fejlesztojenek vagy jelezze valahogyan neki.");
         leir("<========================================================================================================================>");
         leir("O------O------O");
         leir("  A jatekrol:");
         leir("O------O------O");
         ...
         leir("-A lampakat a sorok es oszlopok megadasaval lehet kivalasztani es modositani.");
         leir("VIGYAZ, a kivalasztott lampa koruli ertekek is ugyan ugy valtozni fognak mint a kivalasztott lampa(jobb, bal, fel, le.");
         leir("\t Jo jatekot kivanok!");
         leir("<========================================================================================================================>");
         leir("");
         leir("\t --Nyomja meg az ENTERT a tovabb haladashoz--");
     }
